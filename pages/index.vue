<template>
  <div>
    <div onclick="window.open('https://www.instagram.com/robl_end/')" class="bg-mk" title="Background video by [inst] @robl_end. Click to visit">
      <span v-html="empt" />
    </div>
    <div class="background-video">
      <video
        id="video-tag"
        src="video_backgroundd.mp4"
        playsinline
        muted
        autoplay
        loop
      >
        <source src="video_backgroundd.mp4" type="video/mp4">
      </video>
    </div>
    <div
      id="main"
